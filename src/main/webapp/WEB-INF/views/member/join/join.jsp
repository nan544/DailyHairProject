				...
				<div style="margin: 0 auto; padding: 10px;">
					...
					<form role="form" id="insertForm" name="insertForm">
						<div class="join_input">
							<label for="m_Id" class="msgbox"><span
								style="color: red;">* </span>ID</label> <input type="text" id="m_id"
								name="m_id" placeholder=" ID" />
							<button type="button" class="checkbtn" id="idChk" name="idChk"
								onclick="fn_idChk();" value="N">중복체크</button>
							<br>
							<div id="id_check" style="font-size: 11px;"></div>
						</div>
						<div class="join_input">
							<label for="m_Pwd" class="msgbox"><span
								style="color: red;">* </span>PW</label> <input type="password"
								id="m_pwd" name="m_pwd" placeholder=" PassWord" /><br>
						...
						<div class="join_input">
							<label class="msgbox"><span style="color: red;">*
							</span>성 별</label> <input type="radio" id="m_gender1" name="m_gender" value="남" />
							<label for="m_Gender1">남</label> <input type="radio"
								id="m_gender2" name="m_gender" value="여" /> <label
								for="m_Gender2">여</label>
						</div>
						<div class="join_input">
						...
						<div class="join_input">
							<label for="m_Email" class="msgbox"><span
								style="color: red;">* </span>Email</label> <input type="text"
								id="m_email" name="m_email" placeholder=" Email" /> @ <select
								id="emailDomain">
