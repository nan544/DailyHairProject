					...
					<div>
						...
						<!-- 이미지 2 / 3번 함수 ------------>
							<div class="mySlides fade">
								...
								<img  style="width: 350px; height: 450px;" src="/uploadStorage/HairGoods/<c:out value='${hgDetail.hg_img2}'/>"> 
								</c:if>
							...
							<div class="mySlides fade">
								<c:if test="${not empty hgDetail.hg_img3 }">
									<img  style="width: 350px; height: 450px;" src="/uploadStorage/HairGoods/<c:out value='${hgDetail.hg_img3}'/>"> 
								</c:if>
							...
							<div class="mySlides fade">
								<c:if test="${not empty hgDetail.hg_img4 }">
									<img  style="width: 350px; height: 450px;" src="/uploadStorage/HairGoods/<c:out value='${hgDetail.hg_img4}'/>"> 
								</c:if>
