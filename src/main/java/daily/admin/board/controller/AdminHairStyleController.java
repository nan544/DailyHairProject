...
public class AdminHairStyleController {
	...
	public int hairGoodsInsert(@ModelAttribute AdminHairStyleVO hsvo, Model model, HttpServletRequest request)
		...
		System.out.println(hsvo.getHs_thumb());
		System.out.println(hsvo.getHs_title());
	...
	public String delete(@ModelAttribute AdminHairStyleVO hsvo, Model model) {
		log.info("글삭제 메소드 성공");
		...
		if (delete == 1) {
			...
			url = "admin/board/HairStyleDetail";
		}
